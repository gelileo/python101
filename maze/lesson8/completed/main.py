# Completed code for Lesson 8
# This code includes step-by-step mode with forward and backward navigation.
...
pygame.display.set_caption("Step-by-Step Mode")
...
while running:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_RIGHT and step < len(path):
